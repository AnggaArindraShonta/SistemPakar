            ...
            <div class="col-lg-5 col-md-6 col-8">
                <div class="bg-white rounded10 shadow-lg">
                    <div class="content-top-agile p-40 pb-0">
                        <h2 class="text-primary">Hallo!</h2>
                        <p class="mb-0">Selamat Datang</p>
                    </div>
                    <div style="margin-top: 10px; margin-left: 40px; margin-right: 40px">
                        <form action="<?php echo base_url() ?>authmember/action_register" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <span class="input-group-text bg-transparent"><i class="fa fa-user"></i></span>
                                    <input type="email" id="email" name="email" class="form-control ps-15 bg-transparent" placeholder="Email" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-3">
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-danger mt-5" style="margin-bottom: 20px;">SIGN UP</button>
                                </div>
                            </div>
                        </form>
                    </div>
