                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#edit-<?= $data['kode_gejala']; ?>" title="Edit gejala"><span class="fa fa-edit"></span></a>
                      <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete-<?= $data['kode_gejala']; ?>" title="Delete gejala"><span class="fa fa-trash"></span></a>
                    </td>
                  </tr>
